      ...
      <div className="Panel">
        <ul
          ...
          {[...Array(panelCfg.oscillator.octavesLength)].map((x, i) =>
            <li
              key={i}
              onClick={this.props.onPanelChanged.bind(this,'octave', i)}
            />
          )}
        </ul>
        ...
        <input
          type="range"
          onInput={this.props.onPanelChanged.bind(this,'amplitude')}
          />
        <ul className="types">
          {panelCfg.oscillator.types.map((type, i) =>
            <li
              key={i}
              onClick={this.props.onPanelChanged.bind(this,'type', type)}
            >{type}</li>
          )}
        </ul>
        <input
          type="range"
          onInput={this.props.onPanelChanged.bind(this,'lowPass')}
          />
      </div>
    );
  }

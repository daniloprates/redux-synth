...
import initialStateMain from '../constants/initialState';
import { updateOctave } from '../utils/index';
let initialState = initialStateMain.app;

export default function synthReducer(state = initialStateMain, action) {
  ...
  switch (action.type) {
    ...
    case types.NOTE_ON:
      ...
      notes[action.note] = {
        ...
        velocity: action.velocity || initialState.velocity,
        channel: action.channel || initialState.channel
      };
    ...
    case types.STOP_PLAYING:
      return Object.assign({}, state, {isPlaying: false, notes: initialState.notes});
